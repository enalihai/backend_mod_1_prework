...
# I chose to use the string data type for my name as it is a string. The best ways
# to answer any is_ or has_ etc is with a boolean data type. It is pretty easy to
# choose to use the number data type for the 3rd variable as it is a number.
...
# Yes I checked. It all seems to be in order!!!
